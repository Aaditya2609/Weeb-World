        ...
        <div className='flex flex-row items-center m-4 max-w-fit min-h-fit rounded-3xl bg-transparent'>
            <div className='flex flex-col items-center w-full bg-[rgba(0,0,0,0.8)] p-8 rounded-3xl'>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <button class="m-2 bg-black hover:bg-[#117f95] hover:text-white text-yellow-300 font-bold py-2 px-6 text-xl border rounded">
                        <NavLink to="/Login">Login</NavLink>
                    </button>
                    <button class="m-2 bg-[#e6e4d5] hover:bg-[#117f95] hover:text-white text-[#117f95]   font-bold py-2 px-6 text-xl border  rounded">
