                ...
                <div className='bg-[rgba(0,0,0,0.7)] rounded-xl p-8'>
                    ...
                    <div className="mb-2">
                        ...
                        <input
                            ...
                            className="block w-full px-4 py-2 mt-2 text-black bg-white border rounded-md focus:border-[#16444e] focus:ring-[#117f95] focus:outline-none focus:ring focus:ring-opacity-40"
                        />
                        <button className="block w-2/5 px-1 py-1 my-1 text-md bg-[#e6e4d5] hover:bg-[#117f95] hover:text-white text-[#117f95] font-bold rounded-lg" onClick={() => setShowPassword(!showPassword)}>{showPassword ? "Hide Password" : "Show Password"}</button>
                    </div>
                    <div className="mb-2">
                        <label
                            for="confirmpassword"
                    ...
                    <div className="mt-6">
                        <button className="w-2/3 px-4 py-2 my-2 text-2xl bg-[#e6e4d5] hover:bg-[#117f95] hover:text-white text-[#117f95] font-bold rounded-lg" onClick={handleSignup}>
                            Submit
                        </button>
                    </div>
                </div>
